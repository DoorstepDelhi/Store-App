  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BaseView<BrandsViewModel>(
          onModelReady: (model) =>
              model.productsByBrand(widget.routeArgument.id),
          builder: (ctx, model, child) {
            return model.selectedBrand == null
                ? Center(
                    ...
                    SliverList(
                      delegate: SliverChildListDelegate([
                        Offstage(
                          ...
                          child: Column(
                            children: <Widget>[
                              BrandHomeTabWidget(brand: model.selectedBrand),
                            ],
                          ),
                        ),
                        Offstage(
                          ...
                          child: Column(
                            children: <Widget>[
                              ProductsByBrandWidget(brand: model.selectedBrand)
                            ],
                          ),
                        ),
                        Offstage(
